...
import br.com.github.renato28.javaspringsecurity.domain.medico.MedicoRepository;
...
public class ConsultaService {
    ...
    public Page<DadosListagemConsulta> listar(Pageable paginacao) {
        return consultaRepository.findAll(paginacao).map(DadosListagemConsulta::new);
    }
